...
read
    ...
    bind_profile == local AND profile chosen AND ATOINVEST_S2S_TOKEN unset
...
from account_takeover_investigator.adapters.local.identity import (
    LocalIdentityAdapter,
)
from account_takeover_investigator.adapters.onprem.identity import (
