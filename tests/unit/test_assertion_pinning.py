...
from account_takeover_investigator.adapters.gcp.identity import IapIdentityAdapter
...
def _adapter_module() -> object:
    ...
    return importlib.import_module("account_takeover_investigator.adapters.gcp.identity")
