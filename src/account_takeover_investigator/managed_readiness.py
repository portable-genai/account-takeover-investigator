...
INCOMPLETE_MANAGED_OPERATIONS: tuple[str, ...] = (
    "feature_store.CloudFeatureStoreAdapter.fetch",
    "iam_actions.CloudIamActionsAdapter.enact",
    "narrator.CloudNarratorAdapter.narrate",
    "sessions.CloudSessionAdapter.fetch",
)
