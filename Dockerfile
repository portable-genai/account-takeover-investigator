# Account Takeover Investigator (G4) serving image.
#
...
ENV PYTHONDONTWRITEBYTECODE=1 \
    ...
    ATOINVEST_PROFILE=gcp \
    ATOINVEST_SETTINGS=/app/config/settings.yaml \
    PORT=8080
...
CMD ["sh", "-c", "python -m account_takeover_investigator.managed_readiness && exec uvicorn account_takeover_investigator.api.app:app --host 0.0.0.0 --port ${PORT:-8080}"]
